...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-130-g1d6e43380/BNBFaceMatch.zip",
            checksum: "955b7d9226dbc0392d2d38bfe29da2fa9ac7c42b58a98cd54353ba359275ca08"
        ),
        .target(
