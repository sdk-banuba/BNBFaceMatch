...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-203-g079acbf0ae/BNBFaceMatch.zip",
            checksum: "149fea1dfed1c251a6cec84e99b1e27110fe6c9814ef7b62ef0e592aabab3e5b"
        ),
        .target(
