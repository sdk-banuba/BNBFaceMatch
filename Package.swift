...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.18.2-24-g50ecbc89fd/BNBFaceMatch.zip",
            checksum: "b2cbd739f736536b79e3de0135429872fe95560f1db3590ae1042d3ef663b9db"
        ),
        .target(
