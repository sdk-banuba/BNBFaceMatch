...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-194-gb1629e3e8c/BNBFaceMatch.zip",
            checksum: "48866d047cc4aa4e6e91e59248a17bedaa4cf88551936236181727c83d9d297b"
        ),
        .target(
