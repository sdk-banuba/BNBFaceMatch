...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-199-g2f4e3cf953/BNBFaceMatch.zip",
            checksum: "2be795fe978501b5072edb9277aa2d0238c15e88f2f3e2f77ef5559df58c83d6"
        ),
        .target(
