...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.0-24-gb831098a87/BNBFaceMatch.zip",
            checksum: "d32504bbdb7ca122d56e030df1bd7aeae6f8938e6981bb46f2a8f29cb1a80e40"
        ),
        .target(
