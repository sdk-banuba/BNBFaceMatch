...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-185-gcf256de1ef/BNBFaceMatch.zip",
            checksum: "786e787d385bb55308a56f759986e29557a10558b8efc053a8c11e71e7bf232d"
        ),
        .target(
