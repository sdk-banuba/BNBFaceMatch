...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.10.1-73-g8d138045c3/BNBFaceMatch.zip",
            checksum: "fd022ca0691806ec72dca1bd2bc1540ee607a5757fa874c194e39a283535242d"
        ),
        .target(
