...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-150-gd7caecfaf/BNBFaceMatch.zip",
            checksum: "1572b779beebf8b6c859257a94ce824a7cc499dbb979edd9539dc14b108493bc"
        ),
        .target(
