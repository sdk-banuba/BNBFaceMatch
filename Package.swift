...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-132-g6a6b08380/BNBFaceMatch.zip",
            checksum: "30dbe1c59e034b3537473fab502df52089dcb39e134ef582ed3e9a1858ce4ccd"
        ),
        .target(
