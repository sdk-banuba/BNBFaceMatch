...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-188-g3e9bf00b67/BNBFaceMatch.zip",
            checksum: "29dff67cf8706112c5c8000aca4dccc74156494c20a3d3c3a0cb115b7773e591"
        ),
        .target(
