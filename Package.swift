...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-105-gb559f9611/BNBFaceMatch.zip",
            checksum: "80b7d57c91e4499c9120c89635a0152fff5ca871c69b7120f5e1cddebcd8fcb8"
        ),
        .target(
