...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-178-g3b9a032012/BNBFaceMatch.zip",
            checksum: "a88b5613853098629936934f1d2182b60bbd363961154c04f99df432ab9ab54b"
        ),
        .target(
