...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.1-32-gc91d258b34/BNBFaceMatch.zip",
            checksum: "3dc3a6fd2f7e7099e8fc7f644a1895efbd9ccae86823cb41d63b00c5e6f181a2"
        ),
        .target(
