...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-136-g6ec65980f/BNBFaceMatch.zip",
            checksum: "f70c447ba99326c90f7f932edd766ab0d36dfed6149382bc212e1d2bd5fe45e5"
        ),
        .target(
