...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-178-gf86664003c/BNBFaceMatch.zip",
            checksum: "99ed29870027c38eaf13ea60ed41ea67e360835f9b5f94b80be590175128cb62"
        ),
        .target(
