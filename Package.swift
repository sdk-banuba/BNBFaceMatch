...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.0-66-g886631a577/BNBFaceMatch.zip",
            checksum: "2343578ae664d44e1f2bd5bcbda4a5fc873c9bee60943f42f1a5a44b7af6e767"
        ),
        .target(
