...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-143-g50b5f987b/BNBFaceMatch.zip",
            checksum: "e326ac9ae219d8e7b78b507438303b5de38732cab6507601aeb044973ddae8e9"
        ),
        .target(
