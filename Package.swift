...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-106-g81956e5c7/BNBFaceMatch.zip",
            checksum: "b10f782a3dcd5ef0bbe82cf682dd05aa2ad1ee23bfe525ae243c409537b8af6b"
        ),
        .target(
