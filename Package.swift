...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-271-g70b8136591/BNBFaceMatch.zip",
            checksum: "00d85080afa7dfb9b3905472f3e7eef48571541667efb7b40b52bfd1a10adc47"
        ),
        .target(
