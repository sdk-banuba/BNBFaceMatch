...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-147-gb1b24af02/BNBFaceMatch.zip",
            checksum: "0ee99a09489a887ddf0bc606d0b93c0011586d480bfbd3b1d99cb53094619f8a"
        ),
        .target(
