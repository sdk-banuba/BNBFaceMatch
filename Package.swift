...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-174-gec051bdc7/BNBFaceMatch.zip",
            checksum: "e7a8d3f21890d0548c70e731ff40f627fd3ea29c50bdffe3b39a3f7c89603062"
        ),
        .target(
