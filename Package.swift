...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-173-gee6f2723a/BNBFaceMatch.zip",
            checksum: "5e15817a45dfd26455ed8f9071dc56b7f75db6a5d51da9d23688ae645f214524"
        ),
        .target(
