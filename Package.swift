...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-162-g26e50cae8/BNBFaceMatch.zip",
            checksum: "ba2eeaaeff7471b14a4a876716cde23fefa6987c71d43afb41844a36c885f540"
        ),
        .target(
