...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.6-65-gbf994362d5/BNBFaceMatch.zip",
            checksum: "c18d2267ae8f479846c80a795ed8f019724d327c100b34c5a0a44051aadd024d"
        ),
        .target(
