...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-185-gf41e807277/BNBFaceMatch.zip",
            checksum: "0e1a50c1bc3fbb123f6cc3ccf96b2785d03594a5065d3e183810f0f5208df584"
        ),
        .target(
