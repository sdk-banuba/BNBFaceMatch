...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-184-gd8cb662170/BNBFaceMatch.zip",
            checksum: "86902a992c13a54ed0a6db71717cccb9df8fb5784ccb18137082afb840cd9e9a"
        ),
        .target(
