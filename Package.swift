...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-211-g9ce64ef1c2/BNBFaceMatch.zip",
            checksum: "ff1bfef2cc255562b96b6f4551988d1b0a85ad6a7df6fc1e7d78a43643d2248f"
        ),
        .target(
