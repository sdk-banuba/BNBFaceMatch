...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-219-gefae079ac3/BNBFaceMatch.zip",
            checksum: "a67db9325dc1631da385efd3210ca6bc5f86098624b9cbcd5cbb8da5c59a6538"
        ),
        .target(
