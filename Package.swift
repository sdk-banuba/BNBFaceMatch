...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-217-g36d3a95c51/BNBFaceMatch.zip",
            checksum: "c40b631443e534cc369f05493388cd9b22102b520f1b68383eb1d24d2236c846"
        ),
        .target(
