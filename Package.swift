...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-170-g91aac4bda/BNBFaceMatch.zip",
            checksum: "fd749775e86dfa49785f4c67af797cef1bec84be90227a050ac0a3609c52a05b"
        ),
        .target(
