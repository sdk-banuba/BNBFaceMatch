...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-211-g9b253c9f0f/BNBFaceMatch.zip",
            checksum: "1444fc10581c63e18ff339882a0b31152756b8a25b78e75e95111492f0c1cd59"
        ),
        .target(
