...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-170-g93323bc96/BNBFaceMatch.zip",
            checksum: "1c10771f8291e0021c395f93b0797bc155e7c9bfe237c0166350d189950e0fdb"
        ),
        .target(
