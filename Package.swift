...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-215-g9f21b13b23/BNBFaceMatch.zip",
            checksum: "785b23688481fbcc1f9b5bb9b351106d0a1e1f7158ebcbbca498b90371d4fc7e"
        ),
        .target(
