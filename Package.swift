...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-146-g6f441498b/BNBFaceMatch.zip",
            checksum: "85acbebd51ddc1615ca19982cd6681b4d164d67ccac0a338f9b6478ab049c7a2"
        ),
        .target(
