...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBFaceMatch",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.14.1-183-gf9e3d7354f/BNBFaceMatch.zip",
            checksum: "98e3df75a29189b281a893265eaf446f247b378bd2342552b8e99130b2eddabb"
        ),
        .target(
